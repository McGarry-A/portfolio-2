...
const LETTER_VARIANT = {
  ...
  show: { opacity: 1, y: 0, transition: { duration: 0.001 } },
};
...
export const HAMBURGER_ANIMATIONS = {
  HAMBURGER_VARIANTS,
  FADEIN_RIGHT,
...
export const HERO_ANIMATIONS = { DIV_VARIANT, LETTER_VARIANT, FADEIN_Y, FADEIN_RIGHT, };
